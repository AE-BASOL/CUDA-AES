...
The repo currently implements, tests, and benchmarks ECB, CBC, CFB-128, OFB, CTR, GCM, and CCM for AES-128 and AES-256 in the canonical build. XTS-AES, AES-KW, AES-KWP, GMAC, and CMAC are roadmap items unless later phases update this matrix.
