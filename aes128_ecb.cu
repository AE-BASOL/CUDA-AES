...
__device__ __forceinline__ uint8_t gf_xtime(uint8_t x) {
...
#pragma unroll
        ...
        uint32_t o0 = (uint32_t)sb[s0 & 0xFF] |
                      ((uint32_t)sb[(s1>>8)&0xFF] << 8) |
                      ((uint32_t)sb[(s2>>16)&0xFF] << 16) |
                      ((uint32_t)sb[(s3>>24)&0xFF] << 24);
        uint32_t o1 = (uint32_t)sb[s1 & 0xFF] |
                      ((uint32_t)sb[(s2>>8)&0xFF] << 8) |
                      ((uint32_t)sb[(s3>>16)&0xFF] << 16) |
                      ((uint32_t)sb[(s0>>24)&0xFF] << 24);
        uint32_t o2 = (uint32_t)sb[s2 & 0xFF] |
                      ((uint32_t)sb[(s3>>8)&0xFF] << 8) |
                      ((uint32_t)sb[(s0>>16)&0xFF] << 16) |
                      ((uint32_t)sb[(s1>>24)&0xFF] << 24);
        uint32_t o3 = (uint32_t)sb[s3 & 0xFF] |
...
__global__ void aes128_ecb_decrypt(const uint8_t *in, uint8_t *out, size_t nBlocks) {
    ...
    for(int iter=0; iter<2; ++iter, i+=stride){
        ...
        uint32_t o0 = (uint32_t)is[s0 & 0xFF] |
                      ((uint32_t)is[(s3>>8)&0xFF] << 8) |
                      ((uint32_t)is[(s2>>16)&0xFF] << 16) |
                      ((uint32_t)is[(s1>>24)&0xFF] << 24);
        uint32_t o1 = (uint32_t)is[s1 & 0xFF] |
                      ((uint32_t)is[(s0>>8)&0xFF] << 8) |
                      ((uint32_t)is[(s3>>16)&0xFF] << 16) |
                      ((uint32_t)is[(s2>>24)&0xFF] << 24);
        uint32_t o2 = (uint32_t)is[s2 & 0xFF] |
                      ((uint32_t)is[(s1>>8)&0xFF] << 8) |
                      ((uint32_t)is[(s0>>16)&0xFF] << 16) |
                      ((uint32_t)is[(s3>>24)&0xFF] << 24);
        uint32_t o3 = (uint32_t)is[s3 & 0xFF] |
                      ((uint32_t)is[(s2>>8)&0xFF] << 8) |
                      ((uint32_t)is[(s1>>16)&0xFF] << 16) |
                      ((uint32_t)is[(s0>>24)&0xFF] << 24);
